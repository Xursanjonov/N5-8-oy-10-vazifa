...
import { MenuFoldOutlined, MenuUnfoldOutlined, QrcodeOutlined, AppstoreOutlined, EditOutlined, UserAddOutlined, UserOutlined, LogoutOutlined } from '@ant-design/icons';
...
const Layouts = () => {
    ...
    const siderItemActive = `w-[${collapsed ? '30' : '100'}%] hover:text-black p-3 flex items-center justify-center text-lg gap-4 mx-auto bg-blue-500 font-semibold rounded-md text-[#000]`
    const siderItem = `w-[${collapsed ? '30' : '100'}%] p-3 flex items-center justify-center text-lg gap-4 mx-auto bg-transparent font-semibold rounded-md text-white`

    return (
        <div>
            <Layout>
                <Sider className='h-screen sticky top-0 left-0 bottom-0' trigger={null} collapsible collapsed={collapsed} >
